...
export const fonteGoogleDocs =
  "https://docs.google.com/document/d/1j2yeBHTP5qVTYS6JaBX8RYfOD8Rvn8H4ZhwKfqmNpq4/edit?usp=drivesdk";
...
export const aulas: Aula[] = [
  {
    ...
    blocos: [
      ...
      { tipo: "subsecao", texto: "2.1 Jornada de Trabalho (Tempo de Trabalho)" },
      {
        tipo: "paragrafo",
        texto:
          "A regulação do tempo de trabalho se justifica em virtude de três fundamentos, que vão regular a jornada no sentido de impor um limite de trabalho em determinado período de tempo.",
      },
      {
        tipo: "paragrafo",
        texto:
          "O primeiro fundamento é o biológico, a preservação,o respeito à saúde física e psicológica do trabalhador.",
      },
      {
        tipo: "paragrafo",
        texto:
          "Se o trabalho é um elemento humanizador ele também desumaniza, ele também aliena e causa um estranhamento, porque na sociedade capitalista quando você vende sua força de trabalho é por um tipo de sobrevivência. Quem não precisa trabalhar e coloca os outros para trabalhar não são alienados. O que se produz enquanto vendedor da força de trabalho não é do trabalhador.",
      },
      {
        tipo: "paragrafo",
        texto:
          "A TV Manchete fez um documentário chamado “Xingu, a Terra Mágica” que gravou as várias tribos na reserva do Xingu.",
      },
      {
        tipo: "paragrafo",
        texto:
          "Para o capitalismo a jornada será a base da reprodução do valor, o tempo de trabalho é o grande elemento fixo que existe em qualquer processo de trabalho e a grande referência da extração de valor do trabalho. O que o trabalhador produz tem um valor, mesmo que ele não faça o produto inteiro. Esse trabalho coletivo e social vai ter como critério de extração do valor, o tempo. O tempo é o mais importante da exploração do trabalho. As maiores brigas no direito do trabalho estão no dimensionamento do tempo. Na revolução industrial (1850) na europa que se industrializa não tinha jornada para a jornada, fora o limite físico/geológico (24h) o limite é dado pela exaustão do trabalhador.",
      },
      {
        tipo: "paragrafo",
        texto:
          "A saúde é um direito fundamental que tem como matriz a vida, logo não há sentido em vida sem saúde, afinal é um componente indissociável.",
      },
      {
        tipo: "paragrafo",
      ...
      { tipo: "paragrafo", texto: "Dano difuso (relação fática)" },
      {
        tipo: "paragrafo",
        texto:
          "O segundo fundamento é o social, eu limito a duração do trabalho para o humano ter algum tipo de sociabilidade fora do trabalho, dimensão existencial humana. Sua singularidade é formada a partir da interação com os outros. O que define os limites do que eu sou são os relacionamentos com os outros.",
      },
  ...
  },
  {
    ...
    blocos: [
      ...
      { tipo: "lista", itens: ["Prazo", "Sanção", "Procedimentos concessivos"] },
      {
        ...
        enunciado:
          "Severino foi admitido no dia 05/05/2020 e demitido no dia 15/09/2026 e nunca recebeu nada e nem gozou nada a título de férias, quais são e quantos são os direitos de férias que ele vai pedir.",
        itens: [
  ...
  },
  {
    ...
    meta: "Prof.º Ivan Simões • Data: 17 /09 /2026",
    publicada: false,
    blocos: [],
  },
